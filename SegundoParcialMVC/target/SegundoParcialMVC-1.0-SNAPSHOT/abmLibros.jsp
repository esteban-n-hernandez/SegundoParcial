...
<div id="agregarForm" style="display: none;">
    <form action="abmLibros" method="post">
        ...
        <input type="text" name="nombreAutor" placeholder="Nombre del Autor">
        <input type="text" name="apellidoAutor" placeholder="Apellido del Autor">
        <input type="text" name="nacionalidadAutor" placeholder="Nacionalidad del Autor">
